...
// =============================================================================
// LPA (Logical Physical Address) Type
// =============================================================================
...
#define LPAType_Relay 5
#define LPAType_Input 6
#define LPAType_Card 210
#define LPAType_LED 20
#define LPAType_Buzzer 21
...
typedef enum {
    EventType_Input = 0,
    EventType_AccPoint = 1,
    EventType_Connection = 2,
    EventType_AccessGrant = 10,
    EventType_AccessDeny = 11,
    EventType_Reader = 5,
    EventType_Relay = 6
} EventType_t;
...
typedef enum {
    ...
    ErrorCode_NotFound = 3,
    ErrorCode_AlreadyExists = 4,
    ErrorCode_Database = 5,
